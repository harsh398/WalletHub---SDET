...
<ul><li>Install: java jdk 1.8, chrome latest version</li> 
	...
	<li> PS: the chrome driver  i used if used for  Google Chrome 76  Please use google chrome 76 or you can download chrome driver from https://chromedriver.chromium.org/downloads according to the version of your chrome</li></ul> 
