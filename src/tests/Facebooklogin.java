...
public class Facebooklogin {
	...
	public void setup(){
		...
		System.out.println("1. Test 1 is Starting");
		driver=new ChromeDriver(options);
		driver.get(baseurl);
		System.out.println("2. Redirecting to Facebook");
	...
	public void CanUserPostStatusOnFacebookHome() throws InterruptedException{
		...
		System.out.println("4. Filling Username and Password");
		...
		login_btn.click();
		System.out.println("6. Posting Review");
		...
		System.out.println(post_msg+" Success : status post has been completed, Passing Test!\n\n");
	...
	public void teardown(ITestResult result){
		...
		if(ITestResult.FAILURE==result.getStatus()){
			...
			try{
				...
				System.out.println("Error : Successfully captured a screenshot");
